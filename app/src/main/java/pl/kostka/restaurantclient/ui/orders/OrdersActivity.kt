...
class OrdersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(basket.products.size == 0) {
            ...
            recyclerView.adapter = BasketAdapter(OrderService.getBasket(),this@OrdersActivity)
        }
        ...
        button_basket_confirm_order.setOnClickListener {
            OrderService.makeOrder(object: OrderCallback {
                override fun onResponse(order: Order) {
                    runOnUiThread {
                        Toast.makeText(this@OrdersActivity, "Udało sie", Toast.LENGTH_LONG).show()
                    }
                ...
                override fun onFailure(errMessage: String) {
                    runOnUiThread {
                        Toast.makeText(this@OrdersActivity, errMessage, Toast.LENGTH_LONG).show()
                    }
